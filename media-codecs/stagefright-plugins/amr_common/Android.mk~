...
ifeq (redhookbay,$(wildcard vendor/intel/PRIVATE/media_codecs/stagefright/plugins/amr_common/Android.mk)$(REF_PRODUCT_NAME))# test inexistance of original makefile, and correct ref product
